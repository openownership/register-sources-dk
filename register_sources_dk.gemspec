...
require_relative 'lib/register_sources_dk/version'

Gem::Specification.new do |spec|
  spec.name = 'register_sources_dk'
  spec.version = RegisterSourcesDk::VERSION
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/openownership/register-sources-dk'
